...
echo "    docker compose exec oracle-db sqlplus demo_user/oracle@XEPDB1"
echo ""
echo "  Run load generator:"
echo "    docker compose exec oracle-db sqlplus -S demo_user/oracle@XEPDB1 <<< 'EXEC generate_load;'"
echo ""
